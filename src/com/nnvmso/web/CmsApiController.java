...
public class CmsApiController {
	...
	public @ResponseBody String saveNewProgram(HttpServletRequest req,
		...
		if (program.getContentType() == MsoProgram.CONTENTTYPE_RADIO) {
	...
	public @ResponseBody Long createProgramSkeleton(@RequestParam(required=false) Short contentType) {
		...
		if (contentType != null && contentType == MsoProgram.CONTENTTYPE_RADIO) {
			...
			program = new MsoProgram("New Program", "New Program", "/WEB-INF/../images/processing.png", MsoProgram.TYPE_VIDEO);
			program.setPublic(false);
