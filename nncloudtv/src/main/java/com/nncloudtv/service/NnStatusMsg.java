	...
	public static String getMsg(int status, Locale locale) {
		try {
			switch (status) {
			  ...
			  case NnStatusCode.SUBSCRIPTION_RO_CHANNEL: return messageSource.getMessage("nnstatus.subscription_ro_channel", new Object[] {NnStatusCode.SUBSCRIPTION_RO_CHANNEL} , locale);
