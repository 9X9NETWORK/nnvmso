...
function align_center()
  ...
  for (var v in { signin:0, hint:0, confirm:0, yesno:0, about:0, copy:0 })
...
function switch_to_ipg()
  ...
  $("#ipg-btn-signin, #ipg-btn-edit, #ipg-btn-resume, #ipg-btn-about, #ipg-btn-copy").unbind();
  ...
  $("#ipg-btn-copy")    .removeClass ("on")  .hover (ipg_btn_hover_in, ipg_btn_hover_out); //  .click (copyright);
  ...
  $("#ipg-btn-copy")    .bind ('click', copyright);
...
function copyright()
  ...
  modal_box = true;
  $("#copy-layer").show();
  $("#btn-closeCopy").unbind();
  $("#btn-closeCopy").hover (hover_in, hover_out);
  $("#btn-closeCopy").click (close_copyright);
  elastic();
  }

function close_copyright()
  {
  close_box ('#copy-layer');
  }
...
function close_box (box)
  ...
  var closables = { '#contest-layer':0, '#hint-layer':0, '#about-layer':0, '#copy-layer':0 };
...
function ipg_play()
  ...
  if ($("#copy-layer").css ("display") == 'block')
    {
    close_box ('#copy-layer');
    return;
    }
...
<div id="ipg-layer" style="display: none">
  <div id="ipg-holder">
    <div id="header">
      ...
      <ul id="control-list"><li class="btn" id="ipg-btn-signin"><span id="solicit">Sign in / Sign up</span></li><li class="btn" id="ipg-btn-edit"><span id="edit-or-finish">Delete channel</span></li><li class="btn" id="ipg-btn-resume"><span id="resume1">Resume Watching</span></li><li class="btn" id="ipg-btn-about"><span id="aboutus">About Us</span></li><li class="btn" id="ipg-btn-copy"><span>Copyrights</span></li></ul>
...
<div id="copy-layer">
  <div class="copy-holder">
    <div id="copy-content">
      <h2><span>9x9 Copyright Policy</span></h2>
      ...
      <h3><span>How to Report Copyright Infringement:</span></h3>
      ...
      <h3><span>How to File a Counter-Notice</span></h3>
      <ul class="copy-list">
        <li><span>Your name, address, phone number, email address and signature</span></li>
      ...
      <p><span>If a Counter-Notice is received by the 9x9 Designated Agent, 9x9 may send a copy of the Counter-Notice to the original complaining party who may elect to file a lawsuit against you for copyright infringement.  If 9x9 does not receive a notice that a lawsuit has been filed within ten days after we provide notice of your Counter-Notification, 9x9 will restore the removed materials at 9x9â€™s discretion.</span></p>
    </div>
    <div id="btn-closeCopy"><img src="http://9x9ui.s3.amazonaws.com/9x9playerV47/images/btn_winclose.png"></div>
  </div>
</div>
